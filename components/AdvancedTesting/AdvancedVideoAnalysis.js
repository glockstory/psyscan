...
export default function AdvancedVideoAnalysis({navigation}) {
  return (
    <LinearArea>
      ...
      <GradientButton title={'START THE SCAN'} onPress={() => navigation.navigate("AdvancedVideoAnalysisRecord")}></GradientButton>
    </LinearArea>
  );
}
